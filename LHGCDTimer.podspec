#
# Be sure to run `pod lib lint LHGCDTimer.podspec' to ensure this is a
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = <<-DESC
  LHGCDTimer  should be user-friendly
                       DESC
  ...
  s.source_files = 'LHGCDTimer/Classes/**/*'
